...
4. 樣板已內建固定 UI：左側 Pages/Layers 樹、三段式控制面板、九大分類、可打字數字框、Auto Layout 尺寸模式、Flex 排版控制、雙欄/四欄格線、Figma section 標題、PS 圓角四角連動、位置偏移對齊圖示、拖曳刷數值、undo/redo + 鍵盤快捷鍵。這些**不要重做或改樣式**。
